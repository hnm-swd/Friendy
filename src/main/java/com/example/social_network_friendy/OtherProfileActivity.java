...
//    private boolean isFollowing = false; // Trạng thái mặc định là chưa theo dõi
//
//    @Override
...
//        followersRef = FirebaseDatabase.getInstance().getReference("followers"); // Lưu trữ followers riêng biệt
//
...
//        loadFollowersCount(username); // Load số người theo dõi
//        setupFollowButton(username); // Thiết lập nút Theo dõi
//
...
//                if (snapshot.exists()) {
//                    DataSnapshot userSnapshot = snapshot.getChildren().iterator().next(); // Lấy user đầu tiên từ kết quả
...
//                        bioTextView.setVisibility(View.VISIBLE); // Hiển thị khi có thông tin
//                    } else {
//                        bioTextView.setVisibility(View.GONE); // Giữ ẩn nếu không có thông tin
//                    }
//
//                    // Birth Date
...
//                        birthDateTextView.setVisibility(View.VISIBLE); // Hiển thị khi có thông tin
//                    } else {
//                        birthDateTextView.setVisibility(View.GONE); // Giữ ẩn nếu không có thông tin
//                    }
//
//                    // Location
...
//                        locationTextView.setVisibility(View.VISIBLE); // Hiển thị khi có thông tin
//                    } else {
//                        locationTextView.setVisibility(View.GONE); // Giữ ẩn nếu không có thông tin
//                    }
//
//                    // Ảnh đại diện (nếu có)
//                    String profileImageUrl = userSnapshot.child("profileImageUrl").getValue(String.class);
//                    if (profileImageUrl != null && !profileImageUrl.isEmpty()) {
//                        // Sử dụng Glide để tải ảnh từ URL vào CircleImageView
//                        Glide.with(OtherProfileActivity.this)
//                                .load(profileImageUrl)
//                                ;
//                    }
////                    else {
////                        // Sử dụng ảnh mặc định nếu không có URL ảnh
...
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                long count = dataSnapshot.getChildrenCount(); // Đếm số lượng followers
...
//        if (currentUser == null) {
//            return; // Đảm bảo người dùng đã đăng nhập
//        }
//
//        String currentUserId = currentUser.getUid(); // Lấy ID người dùng hiện tại từ Firebase Auth
//
//        // Kiểm tra xem user hiện tại đã theo dõi chưa
...
//
//                // Tăng số followers
//                loadFollowersCount(usernameToFollow); // Đảm bảo tải lại số followers sau khi thay đổi
//            } else {
//                // Xóa người theo dõi
